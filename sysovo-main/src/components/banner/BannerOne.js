                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-5">
                            <div className="banner-wrapper-one">
                                <span className="pre-title" data-aos="fade-up" data-aos-duration="1000">Sysovo</span>
                                <h1 className="title" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">
                                    IT Services Provider for <span>Startups</span> and Businesses
                                </h1>
                                <p data-aos="fade-up" data-aos-delay="500">
                                    Strategy and scalable technology partner for businesses that want to create value, expand and lead.
                                </p>
                                <a
                                    href="/service"
